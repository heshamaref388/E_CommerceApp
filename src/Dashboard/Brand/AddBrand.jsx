...
function AddBrand() {
  ...
  const uploadData = async (e) => {
    ...
    try {
      await axios
        .post(`/DashboardBrand/addbrand`, formData, {
          headers: {
          ...
          <form onSubmit={uploadData}>
            ...
            <div className="focus:outline-none grid gap-4 mb-4 sm:grid-cols-2">
              <div className="focus:outline-none sm:col-span-2">
                <label
                  htmlFor="name"
                  className="focus:outline-none block mb-2 text-sm font-medium text-gray-900 "
                >
                  Brand Name
                </label>
                <input
                  ...
                  name="name"
                  id="name"
                  className="focus:outline-none bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-indigo-600 focus:border-indigo-600 block w-full p-2.5 "
                  placeholder="Apple"
                />
              </div>
