      ...
      {cartProducts ? (
        <div className="container mb-3 ">
          <div className="d-flex justify-content-between align-items-center">
            <img
              src={require("../../Images/green_shoppictcart_1484336527-1.png")}
              className="w-25"
              style={{ height: "400px" }}
              alt=""
            />
          ...
          <div className="row gx-5">
            {cartProducts.map(function (cart, idx) {
              return (
                <div
                  key={idx}
                  className="py-3 border-bottom border-1 border-dark d-flex align-items-center justify-content-between"
                >
                  {" "}
                  <div key={idx} className="col-md-3 rounded-5  ">
                    <img
                  ...
                  <div className="col-md-4 text-start ">
                    <div className="product rounded-5 ">
                      <h6 className="text-success">
                        {cart.product.title?.slice(
                          0,
                          cart.product.title.indexOf(" ", 10)
                        )}
                      </h6>
                      <h6 className="text-muted">
                        Price :{" "}
                        <span className="text-success"> {cart.price} EGP</span>
                      </h6>

                      <button
                        onClick={function () {
                          removeItemFromCart(cart.product.id);
                        }}
                  ...
                  <div className="col-md-4 text-center d-flex align-items-center justify-content-center ">
                    <button
                      onClick={function () {
                        decProduct(cart.product.id, cart.count - 1);
                      }}
                    ...
                    <button
                      onClick={function () {
                        incProduct(cart.product.id, cart.count + 1);
                      }}
