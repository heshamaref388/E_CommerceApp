  ...
  return (
    <HelmetProvider>
      ...
      <h3 className="my-5 pt-5 text-success fw-bolder text-center text-muted">
        Welcome User to Payment{" "}
        <i className="fa-solid fa-money-bill-1-wave text-success"></i>
      </h3>
        ...
        <div className="container text-center mb-5">
          <div className="m-auto w-50 text-start fw-bolder">
            <form>
              ...
              <input
                type="text"
                className="px-3 form-control mb-2"
              ...
              <div className="row d-flex justify-content-between align-items-center">
                <div className="col-md-6 ">
                  <button
                    ...
                    type="button"
                    className="btn btn-outline-success fw-bolder mx-4 my-3"
                  >
                    Cash Payment
                  </button>
                  <button
                ...
                <div className="col-md-6 d-flex justify-content-between align-items-center">
                  ...
                  />
                  <img
                    src={require("../../Images/americanexpress.png")}
                    style={{ width: "20%" }}
                    alt={"americanexpress"}
                  />
                  <img
