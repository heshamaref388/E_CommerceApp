  ...
  let formik = useFormik({
    ...
    validate: function (values) {
      ...
      if (values.name.length < 3 || values.name.length > 14) {
        errors.name =
          "Name Must Be More Than 3 Characters and Less Than 14 Characters";
      }
  ...
  return (
    <HelmetProvider>
      ...
      <div className="container py-5 mt-5">
        ...
        <div
          style={{ display: "none" }}
          className="errMsg text-center alert alert-danger"
        >
        ...
        <div
          style={{ display: "none" }}
          className="sucMsg text-center alert alert-success"
        >
          <h3>Congratulations</h3>
        </div>

        <form onSubmit={formik.handleSubmit}>
          <label className="mt-2 fw-bolder displayy" htmlFor="name">
            Name
          </label>
          <input
