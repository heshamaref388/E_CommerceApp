  ...
  const router = createBrowserRouter([
    {
      ...
      children: [
        ...
        { path: "Dashboard", element: <AddBrand /> },
        ...
        {
          path: "login",
          element: <Login getUserData={getUserData} crrUser={crrUser} />,
        },
        {
          path: "profile",
          element: (
        ...
        { path: "brands", element: <Brands /> },
        {
          ...
          element: (
            <div className="text-center mt-5 w-100">
              <img
                src={require("./Images/404-Error-0.jpg")}
                className="w-100"
                alt=""
              />
            </div>
